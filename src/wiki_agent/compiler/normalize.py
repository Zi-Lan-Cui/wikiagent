...
from wiki_agent.compiler.checks import _iter_code_runs, iter_text_outside_code
from wiki_agent.compiler.quality import Issue, check_page_quality
...
def inject_metadata(
    content: str, *, source_identity: str, today: str, existing: dict | None,
) -> str:
    ...
    if "sources:" in new_fm:
        new_fm = re.sub(
            r"^sources:.*$", f"sources: [{sources_str}]",
