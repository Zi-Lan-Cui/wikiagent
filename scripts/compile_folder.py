...
from wiki_agent.compiler.wiki.quality import format_scan_report, scan_source, scan_wiki
...
async def compile_folder(
    ...
    *,
    ...
    failure_handler = SourceFailureHandler(queue, mode="compile")
...
async def main(source_dir: str):
    """脚本兼容入口。"""
    await compile_folder(source_dir)
